...
async function safeGetState(config: InjectConfig, convId: string): Promise<ConvStateRow | null> {
  try {
...
async function callTool(
  ...
  try {
    const parsed = JSON.parse(text) as ConvStateRow;
